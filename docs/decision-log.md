...
| 2026-04-16 | Fluss 1.0-SNAPSHOT (local build) | — | Latest features (STS endpoint, IRSA). Helm chart from fluss-main/helm/ |
...
| 2026-04-16 | LocalStack for S3-compatible tests | — | S3 + STS on single port, no auth, free community edition |
...
| 2026-04-16 | LocalStack for S3-compatible tests | — | S3 + STS on single port, no auth, free community edition |
| 2026-04-18 | Apache Polaris for Iceberg catalog | — | REST catalog, Helm chart available, replaces JDBC/HMS |
| 2026-04-19 | Fluss 1.0-SNAPSHOT migration | — | STS endpoint override, IRSA support, AssumeRole with LocalStack. Eliminates $lake workaround |
